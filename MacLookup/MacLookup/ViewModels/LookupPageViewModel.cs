...
namespace MacLookup.ViewModels {
    ...
    public class LookupPageViewModel : BindableBase {
        ...
        {            
            ...
            string cc = "1xx";
            System.Diagnostics.Debug.WriteLine("MAC: "+ _macInput.Replace(":", "").Substring(0, 6)+"//"+cc);
        ...
        async void ExecuteOpenBarcodeScanner()
        {
